...
BEGIN
  ...
  END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='complaints' AND column_name='urban_impact_score') THEN
...
-- 13. Complaint Upvotes Tracking Table & Upvote PL/pgSQL Function
